 ...
 */
public class FarmControlCenterActivity extends AppCompatActivity {
    ...
    private TextView textview_humidity_status;
    private ImageView imageview_farm_setting;
    private ImageView imageview_farm_alert;
    private ImageView imageview_humidity_sensor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farm_control_center2);
        ...
        imageview_humidity_sensor = findViewById(R.id.imageView_humiditySensor);
        textview_farm_title = findViewById(R.id.farm_title);
        textview_farm_description = findViewById(R.id.farm_description);
        textview_humidity_status = findViewById(R.id.textview_humidity_status);
    ...
    void initialFarmData()
    {
        ...
        farm.humidity_sensor_id = getIntent().getExtras().getString("humidity_id");
...
//mMainpump.clear();
    ...
    void updateHumidityUI()
    {
        ...
        Sensor sensor = mapOfSensor.get(farm.humidity_sensor_id);
    ...
    void updateFarmUI()
    {
        ...
        if(farm.isActivated())
        {
            ...
            if(Float.parseFloat(sensor.field1) > Float.parseFloat(farm.humidity_critical_point)) {
                textview_humidity_status.setText("ค่าความชื้นล่าสุด " + sensor.field1.substring(0, 5) + "% > ค่าวิกฤตที่ " + farm.humidity_critical_point + "%");
                textview_humidity_status.setTextColor(getResources().getColor(R.color.white));
                textview_humidity_status.clearAnimation();
                imageview_humidity_sensor.setColorFilter(getResources().getColor(R.color.white));
                imageview_farm_alert.setVisibility(View.INVISIBLE);

            }else{
                textview_humidity_status.setText("ค่าความชื้นล่าสุด " + sensor.field1.substring(0, 5) + "% < ค่าวิกฤตที่ " + farm.humidity_critical_point + "%");
                textview_humidity_status.setTextColor(getResources().getColor(R.color.red));
                textview_humidity_status.setAnimation(AnimationUtils.loadAnimation(context, R.anim.text_flash));
                imageview_farm_alert.setVisibility(View.VISIBLE);
                imageview_humidity_sensor.setColorFilter(getResources().getColor(R.color.red));
            }
            activateOnUI();
        }
        else
        {
            ...
            textview_humidity_status.clearAnimation();
            textview_humidity_status.setText("ค่าความชื้นล่าสุด -- %");
            textview_humidity_status.setTextColor(getResources().getColor(R.color.white));
            imageview_humidity_sensor.setColorFilter(getResources().getColor(R.color.white));
            imageview_farm_alert.setVisibility(View.INVISIBLE);
            // disable all mainpump and valve
            activateOffUI();
        }
    }
